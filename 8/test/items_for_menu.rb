module ItemsForMenu
  ...
  SMALL_SECTION_SEPARATOR = "_________________________________________________________________________________________________".freeze
  ...
  ENTER_TRAINS_MANAGMENT = 'Введите номер поезда, либо(e- закончить создание поездов, r- назначить маршрут поездам, l- список поездов): '.freeze
  ...
  SELECT_CARRIAGE_TO_MANAGE = "Выберите вагон для управления: "
  ...
  SELECT_CREATE_ROUTE = "1)Создать маршрут".freeze
  ...
  ADD_VOLUME_CARGO = "Место для груза зарезервировано".freeze
  ADD_SEAT_PASSENGER = "Место для пассажира зарезервировано".freeze
  ...
  def enter_menu_type_carriages_if_carriages_attached_to_train
    ...
    puts "5) Просмотр свободных и занятых мест в вагонах"
  end
  ...
  def select_carriage_to_manage
    print SELECT_CARRIAGE_TO_MANAGE
  end
  ...
  def select_create_route
    puts SELECT_CREATE_ROUTE
  end

  def select_create_route_if_created_routes
    puts "2)Редактировать маршруты"
  end
