...
class Main < Core
  def initialize
    ...
    @stations = []
    @trains = []
    @commands = {1 => 'Менеджер станций', 2 => 'Менеджер поездов', 3 => 'Менеджер маршрутов', 4 => 'Менеджер вагонов', 5 => 'Интерфейс управления поездами', 6 => 'Стастистика по станциям и поездам' }
  end
